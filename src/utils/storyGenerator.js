...
✅ 关卡幕：
type: "challenge", narrative: "走廊尽头出现一扇密码门。门上的屏幕闪着数字：3×7=? '这不是考我吗？' ${characterName || '小明'}挠挠头。", questions: [{ type: "choice", text: "密码门上显示：3×7=？", options: ["18", "21", "24", "27"], correct: 1, explanation: "叮！密码正确！门缓缓打开了，里面金光闪闪！", hint: "想想三七多少" }]
